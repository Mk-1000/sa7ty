 ...
 */
final class Version20240217102803 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE appointment (id INT AUTO_INCREMENT NOT NULL, date INT NOT NULL, hour INT DEFAULT NULL, patient_status TINYINT(1) DEFAULT NULL, progress VARCHAR(255) NOT NULL, patient_id INT NOT NULL, secretary_id INT DEFAULT NULL, consultation_id INT DEFAULT NULL, INDEX IDX_FE38F8446B899279 (patient_id), INDEX IDX_FE38F844A2A63DB2 (secretary_id), UNIQUE INDEX UNIQ_FE38F84462FF6CDF (consultation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE appointment ADD CONSTRAINT FK_FE38F844A2A63DB2 FOREIGN KEY (secretary_id) REFERENCES secretary (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE appointment DROP FOREIGN KEY FK_FE38F844A2A63DB2');
